# Simple deployment script for Furtim Move contracts
# PowerShell script for Windows

Write-Host "Starting Furtim Move contract deployment..." -ForegroundColor Green
...
# Get the deployed address (we know it from the deployment)
Write-Host "Getting deployed address..." -ForegroundColor Blue
$deployedAddress = "0x1940a668edefccee50f116ea193b6c040e65395561158e662d32b6ab427cbbd8"
Write-Host "Deployed address: $deployedAddress" -ForegroundColor Green
...
Write-Host "   - Address: $deployedAddress" -ForegroundColor White
Write-Host ""
